...
<div class="container" >
        ...
        <div class="list-group">
            <a href="<?=base_url('')?>" class="list-group-item list-group-item-action">Cocineros</a>
            <a href="<?=base_url('')?>" class="list-group-item list-group-item-action">Meseros</a>
            <a href="<?=base_url('')?>" class="list-group-item list-group-item-action">Pedidos</a>
