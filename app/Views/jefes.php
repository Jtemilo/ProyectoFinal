...
<head>
    ...
    <title>Pagina Gerentes cafetería el paladar</title>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action = "<?=base_url('guardar_jefes')?>" method="post">
      <div class="mb-3">
  <label for="formGroupExampleInput" class="form-label">Agregar ID del gerente</label>
  <input type="text" class="form-control" name="txt_codigo" placeholder="Codigo Gerente">
</div>
<div class="mb-3">
  <label for="formGroupExampleInput2" class="form-label">Agregar Nombre</label>
  <input type="text" class="form-control" name="txt_nombre" placeholder="Nombre Gerente">
</div>
<div class="mb-3">
  <label for="formGroupExampleInput2" class="form-label">Agregar Apellido</label>
  <input type="text" class="form-control" name="txt_apellido" placeholder="Apellido Gerente">
</div>
<div class="mb-3">
...
<div class="mb-3">
  <label for="formGroupExampleInput2" class="form-label">Tipo de Usuario</label>
  <input type="text" class="form-control" name="txt_user" placeholder="Usuario 1-2">
</div>
<div class="mb-3">
  <button type="submit" class="btn btn-dark">Guardar Registro</button>
      ...
      <div class="modal-footer">
        ...
        <table class="table table-dark table-striped pt-3 pb-3" id="dataTable">
            ...
            <tbody>
                <?php
                foreach ($lista_jefes as $elemento_gerente):


                ?>
                    <tr>
                        <td><?= $elemento_gerente['gerente_id'] ?></td>
                        <td><?= $elemento_gerente['nombre'] ?></td>
                        <td><?= $elemento_gerente['apellido'] ?></td>
                        <td><?= $elemento_gerente['contra'] ?></td>
                        <td><?= $elemento_gerente['tipo_usuario'] ?></td>
                        <td>
                            <a href="<?=base_url('eliminar_jefes/'.$elemento_gerente['gerente_id'])?>">Eliminar</a>
                            /
                           <a href="<?=base_url('actualizar_jefes/'.$elemento_gerente['gerente_id'])?>">Actualizar</a>
                        </td>
