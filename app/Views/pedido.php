  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action = "<?=base_url('guardar_pedidos') ?>" method="post">
      <div class="mb-3">
  <label for="formGroupExampleInput" class="form-label">Identificador del pedido</label>
  <input type="text" class="form-control" name="txt_codigo" placeholder="ID del pedido">
</div>
<div class="mb-3">
  <label for="formGroupExampleInput2" class="form-label">Codigo de Mesero</label>
  <input type="text" class="form-control" name="txt_mesero" placeholder="Codigo del 1 al 4">
</div>
<div class="mb-3">
  <label for="formGroupExampleInput2" class="form-label">fecha del pedido</label>
  <input type="date" class="form-control" name="txt_fecha" placeholder="Agregar Fecha">
</div>
<div class="mb-3">
  <label for="formGroupExampleInput2" class="form-label">Codigo del gerente</label>
  <input type="text" class="form-control" name="txt_gerente" placeholder="Ingrese del 1 al 2">
</div>
<div class="mb-3">
  <label for="formGroupExampleInput2" class="form-label">Lugar y Hora</label>
  <input type="text" class="form-control" name="txt_hora" placeholder="Guatemla, 24:00">
</div>
<div class="mb-3">
  <button type="submit" class="btn btn-dark">Guardar Registro</button>
      ...
      <div class="modal-footer">
        ...
        <table class="table table-dark table-striped pt-3 pb-3" id="dataTable">
            ...
            <tbody>
                <?php
                foreach ($lista_pedidos as $elemento_pedidos):


                ?>
                    <tr>
                        <td><?= $elemento_pedidos['id_pedido'] ?></td>
                        <td><?= $elemento_pedidos['cod_mesero'] ?></td>
                        <td><?= $elemento_pedidos['fecha_pedido'] ?></td>
                        <td><?= $elemento_pedidos['gerente_id'] ?></td>
                        <td><?= $elemento_pedidos['fecha_hora'] ?></td>
                        <td>
                            <a href="<?= base_url('eliminar_pedidos/' .$elemento_pedidos['id_pedido'])?>">Eliminar</a>
                            /
                           <a href="<?=base_url('actualizar_pedidos/'.$elemento_pedidos['id_pedido'])?>">Actualizar</a>
                        </td>
