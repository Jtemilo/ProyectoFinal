  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action = "<?=base_url('guardar_tamaño') ?>" method="post">
      <div class="mb-3">
  <label for="formGroupExampleInput" class="form-label">Agregar Codigo</label>
  <input type="text" class="form-control" name="txt_codigo" placeholder="Codigo Tamaño">
</div>
<div class="mb-3">
  <label for="formGroupExampleInput2" class="form-label">Agregar Nombre</label>
  <input type="text" class="form-control" name="txt_tamaño" placeholder="Nombre Tamaño">
</div>
<div class="mb-3">
  <button type="submit" class="btn btn-dark">Guardar Registro</button>
      ...
      <div class="modal-footer">
        ...
        <table class="table table-dark table-striped pt-3 pb-3" id="dataTable">
            ...
            <tbody>
                <?php
                foreach ($lista_tamaños as $elemento_tamaño):


                ?>
                    <tr>
                        <td><?= $elemento_tamaño['id_tamaño'] ?></td>
                        <td><?= $elemento_tamaño['tamaño'] ?></td>
                        <td>
                            <a href="<?= base_url('eliminar_tamaño/' .$elemento_tamaño['id_tamaño'])?>">Eliminar</a>
                            /
                           <a href="<?=base_url('actualizar_tamaño/'.$elemento_tamaño['id_tamaño'])?>">Actualizar</a>
                        </td>
